...
Fork from GITHUB  https://github.com/vgod/vimrc.
...
Use curl (for Mac OS X):
     ...
     curl -o - https://raw.github.com/ArnoldWu/vimrc/master/auto-install.sh | sh

or wget (for most UNIX platforms):

     wget -O - https://raw.github.com/ArnoldWu/vimrc/master/auto-install.sh | sh
...
1. Check out from github
        ...
        git clone git://github.com/ArnoldWu/vimrc.git ~/.vim
        cd ~/.vim
...
1. Check out from github
        ...
        git clone git://github.com/ArnoldWu/vimrc.git vimfiles
        git submodule update --init
